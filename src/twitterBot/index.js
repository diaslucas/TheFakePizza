  ...
  stream.on('tweet', async function (tweet) {
    ...
    if (isOpen) {
      if (matchesPizzas) {
        ...
        replyText = `Here is our menu ${process.env.URL}/menu`;
      } else {
        replyText = `Sorry! This is not a valid command. You can check our command list here ${process.env.URL}/commands`
      }
